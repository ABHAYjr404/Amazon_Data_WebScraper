...
#edit url of category u wish to scrape data for. Below is example of category-snacks
URL = "https://www.amazon.in/s?k=snacks&crid=3KHTSIK0UBZ4H&qid=1723789405&sprefix=snacks%2Caps%2C196&ref=sr_pg_1"
...
def main(max_products=1000): #edit as per need
    ...
    for i in pages:
        ...
        for j in range(len(results)-1): #new
    ...
    for row in answer:
        ...
        with open('anyfilename.csv', 'w', encoding='utf-8') as csvfile: #edit filename here
